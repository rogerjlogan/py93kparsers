...
PB_PLL_1PR_AA_3_PG_AtSpeedVskewPhi_st:
  ...
  override_testf = tm_4;
  override_tim_spec_set = "a99pASY1_pASY5_pASY3nALT_pNONASYNC1_WFT5X4_MPT_VskewPhi";
  override_timset = 1;
  site_control = "parallel:";
  site_match = 2;
...
PB_PLL_DSP_T0_F_PG_AtSpeedVskewPhi_st:
  ...
  override_tim_spec_set = "a99pASY1_pASY5_pASY3nALT_pnASY1_WFT5X4_MPT_2_VskewPhi";
  override_timset = 1;
  site_control = "parallel:";
  site_match = 2;
...
test_flow

  {
    ...
    {
       run_and_branch(CTCS_START_Vskew)
       then
       {
       }
       else
       ...
       }, open, "SpeedSort_AtSpeedVskewPhi", ""
       run_and_branch(CTCS_Vskew)
       then
       {
       }
       else
