...
tm_2:
  ...
  "End Of Flow Warm Up Time Out" = "30";
  "Lower Limit Range Offset Temperature" = "0";
  "Pattern name to cool down device" = "dummy_reset_PBIST_pNONASYNC1_MPB";
  "Pattern name to warm up device" = "PB_PLL_WARMUP_MPB";
  "SPT OFFSET" = "0";
  "Thermo Control Mode" = "START DATALOG CTCS";
  "Time Between TD Reading" = "1";
  "Upper Limit Range Offset Temperature" = "10";
  "WarmUpLevelsCorner" = "VmaxOK";
  "WarmUpLevelset" = "2";
  "WarmUpTimingSet" = "1";
  "WarmUpTimingSpecName" = "PB_PLL_pASYNC2_WFT7X4_MPT_10";
tm_3:
  "Auto Tune PID temperature" = "0";
  "Control Temperature" = "0";
  "Enable Cooling" = "0";
...
CTCS_START_Thermal:
  ...
  override_levset = 2;
  override_testf = tm_2;
  override_tim_spec_set = "Therm_Sensor_spec";
  override_timset = 1;
  site_control = "parallel:";
  site_match = 2;
CTCS_Start_st:
...
test_flow

  {
    ...
    if @TITESTTEMP == "TEMP_COLD_DEG" then
    {
